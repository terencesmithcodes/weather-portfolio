...
const Api_key = "78f035204f2a98a47af8dec26c3213d4";
...
const App = () => {
  ...
  const fetchWeather = async () => {
    const URL = `https://api.openweathermap.org/data/2.5/weather?q=${inputRef.current.value}&units=imperial&appid=${Api_key}`;
